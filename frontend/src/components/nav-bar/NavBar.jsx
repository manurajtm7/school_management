            ...
            >
              <li role="none" className="flex items-stretch">
                <a
                  role="menuitem"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 transition-colors duration-300 hover:text-primary focus:text-dark focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                >
                  <span>Dashboard</span>
                </a>
              ...
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-current="page"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 text-primary transition-colors duration-300 hover:text-dark focus:text-dark focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                >
                  <span>users</span>
                </a>
